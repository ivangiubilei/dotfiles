...
-- custom commands
vim.g.capitalize_script = "~/Documents/dev/elixir/capitalize/lib/capitalize.exs"

-- Create a user command that calls the Elixir script
vim.api.nvim_create_user_command("Capitalize", function()
	vim.cmd("'<,'>!elixir " .. vim.g.capitalize_script)
end, { range = true })
